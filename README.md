# Imported Models for Ultimate Admiral: Dreadnoughts
Adds new custom-made models of guns, towers, hulls, and more into Ultimate Admiral: Dreadnoughts.

Designed for use with the [Dreadnought Improvement Project](https://www.nexusmods.com/ultimateadmiraldreadnoughts/mods/7?tab=description) in mind, but it can be used standalone, although having Tweaks and Fixes (TAF) installed alongside is recommended.
